...
# type = "automatic800"
for it in range(1,2):
    test_data_dir = "cap/fine_tune_dataset/test"
    ...
    model_path = "cap_fine_tune_model_path.pth"
    ...
    print('Accuracy of the network on the test images: %.1f%%,correct = %d,total = %d' % (100 * correct / total, correct, total))
